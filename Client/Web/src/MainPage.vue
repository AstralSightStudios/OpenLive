      ...
      <div class="container">
        ...
        <div id="chat_area" class="surface-variant">
          <div id="chat_content_show_area"
            style="position: absolute; width: 90%; height: 440px; top: 10px; left: 5%; overflow: scroll; color: white; font-family: Noto Sans SC; overflow-x: hidden;">
            OpenLiveUser: 主播现在塔菲在播原神<br />
            TestUser1: 真的吗111<br />
            OpenLiveUser: 主播是真的关注塔菲谢谢喵<br />
          </div>
          <md-filled-text-field id="chat_msg_input" label="接下来该说些什么呢..." labelStyle="{fontSize: '4px'}"
          ...
          <md-filled-tonal-button style="top: 465px;position: absolute; left: 70%;" @click="send_chat_msg_click">
            发送
...
import { wip_alert, userinfo_div_click, go_register_click, go_back_login_click, go_register_setname_click, go_back_register_from_setname_click, login_click, register_click, send_chat_msg_click } from '@/page_onclick_process';
